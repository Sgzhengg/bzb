...
CATEGORY_MAPPING = {
    "广告": ["广告", "媒介资源投放", "品牌宣传传播", "物料制作印刷", "视频内容制作",
             ...
             "广告宣传策划及品牌活动执行"],
    "工程": ["通信工程建设", "设计勘察", "土建"],
    "维护": ["网络维护代维", "设备维保", "安全技术支持", "维护"],
    "ICT": ["ICT系统集成", "软件开发", "大数据AI", "信息安全", "云"],
    "设备": ["服务器存储", "网络设备", "终端及配套", "设备采购"],
    "物业": ["行政物业", "食堂餐饮", "办公后勤", "食堂", "物业"],
}
...
async def fetch_announcements(
    ...
    adapter: Optional[str] = Query(None, description="指定适配器: b2b_10086(移动)/telecom(电信)/unicom(联通)/all(全部运营商)"),
    category: Optional[str] = Query(None, description="分类: operator(运营商)，仅 adapter=all 时生效"),
