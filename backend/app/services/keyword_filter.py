...
ALL_CITIES: List[str] = [
    ...
    # 黑龙江
    "黑龙江", "哈尔滨", "齐齐哈尔", "大庆", "牡丹江", "佳木斯", "绥化", "鸡西", "鹤岗", "双鸭山", "伊春", "七台河", "黑河",
    # 吉林
    "吉林", "长春", "四平", "辽源", "通化", "白山", "松原", "白城", "延边",
    # 甘肃
    "甘肃", "兰州", "天水", "白银", "金昌", "嘉峪关", "酒泉", "张掖", "武威", "定西", "陇南", "平凉", "庆阳",
    # 内蒙古
    "内蒙古", "呼和浩特", "包头", "鄂尔多斯", "赤峰", "通辽", "呼伦贝尔", "乌兰察布", "巴彦淖尔", "乌海",
    # 新疆
    "新疆", "乌鲁木齐", "克拉玛依", "吐鲁番", "哈密", "昌吉", "伊犁", "喀什", "阿克苏",
    # 西藏
