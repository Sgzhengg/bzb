...
INDUSTRY_CATEGORIES: Dict[str, List[Dict[str, Any]]] = {
    "运营商": [
        ...
        # ── 非广告类（细分赛道，按 specificity 排序：先精确后宽泛）──
        # 设计勘察
        ...
        # ── ICT 类细分 ──
        {"category": "信息安全", "keywords": ["网络安全", "漏洞管理", "安全评估", "威胁分析", "防火墙", "安全平台", "等保", "攻防演练", "数据安全", "安全运营", "安全服务", "反诈模型"]},
        {"category": "大数据AI", "keywords": ["大数据", "云计算", "AI", "人工智能", "机器学习", "大模型", "算法", "数据平台", "数据分析", "智能应用", "数智化", "数字人"]},
        {"category": "软件开发", "keywords": ["软件开发", "定制开发", "系统开发", "应用开发", "软件采购", "代码开发", "研发服务"]},
        {"category": "ICT系统集成", "keywords": ["系统集成", "ICT", "平台建设", "管理系统", "软硬件", "信息化", "云平台", "智慧教育", "智慧城市", "视频监控", "监控系统", "指挥平台", "应用系统", "支撑系统", "运营平台"]},
        # ── 维护类细分 ──
        {"category": "设备维保", "keywords": ["维保", "维修", "保养", "设备维护", "硬件维护", "驻场维护", "巡检维护"]},
        {"category": "网络维护代维", "keywords": ["网络维护", "代维", "运维", "网络优化", "线路维护", "网络支撑", "驻点维护", "机房维护"]},
        {"category": "安全技术支持", "keywords": ["技术支持", "技术支撑", "安全保障", "重大活动保障", "应急支撑", "技术保障", "专项行动"]},
        # ── 设备类细分 ──
        {"category": "服务器存储", "keywords": ["服务器", "存储", "磁盘", "硬盘", "内存", "网卡", "计算节点"]},
        {"category": "网络设备", "keywords": ["交换机", "路由器", "网关", "防火墙设备", "负载均衡", "网络设备"]},
        {"category": "终端及配套", "keywords": ["终端设备", "前置柜", "对讲机", "路由器终端", "智能硬件", "办公设备", "UPS", "空调", "电源", "设备采购", "设备租赁"]},
        # ── 物业类细分 ──
        {"category": "食堂餐饮", "keywords": ["食堂", "食材", "餐饮", "供餐", "团餐"]},
        {"category": "办公后勤", "keywords": ["物业", "保安", "保洁", "绿化", "消防", "车辆", "办公用品", "速递", "快递", "租赁服务", "消防设施", "检测服务", "服务外包", "后勤"]},
    ],
    "银行": [
