...
INDUSTRY_CATEGORIES: Dict[str, List[Dict[str, Any]]] = {
    "运营商": [
        {"category": "广告创意设计", "keywords": ["广告设计", "广告创意", "平面设计", "VI设计", "全案策划", "品牌设计"]},
        {"category": "物料制作印刷", "keywords": ["物料制作", "宣传物料", "喷绘", "印刷品", "门头招牌", "展架", "海报"]},
        {"category": "活动策划执行", "keywords": ["活动策划", "活动执行", "营销活动", "发布会", "路演", "展会", "校园营销"]},
        {"category": "品牌宣传传播", "keywords": ["品牌宣传", "品牌推广", "媒体宣传", "公关传播", "整合营销"]},
        {"category": "视频内容制作", "keywords": ["视频制作", "宣传片", "短视频", "动画", "拍摄"]},
        {"category": "新媒体运营", "keywords": ["新媒体", "公众号", "抖音", "直播运营", "H5"]},
        {"category": "媒介资源投放", "keywords": ["广告投放", "媒介", "户外广告", "电梯广告", "信息流"]},
        {"category": "渠道营销推广", "keywords": ["渠道营销", "网格营销", "地推", "门店推广", "商圈推广"]},
        {"category": "通信工程建设", "keywords": ["基站", "机房建设", "光缆", "管线", "铁塔", "室分", "配套施工", "土建"]},
        {"category": "ICT系统集成", "keywords": ["系统集成", "ICT", "软件开发", "平台建设", "管理系统", "大数据", "云计算", "AI"]},
        {"category": "设备采购", "keywords": ["服务器", "交换机", "路由器", "存储", "网络设备", "UPS", "空调", "电源"]},
        {"category": "网络维护代维", "keywords": ["网络维护", "代维", "运维", "维保", "网络优化", "线路维护"]},
        {"category": "行政物业", "keywords": ["物业", "保安", "保洁", "食堂", "绿化", "消防", "车辆", "办公用品"]},
    ],
    "银行": [
